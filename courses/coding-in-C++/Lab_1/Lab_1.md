...
* __Requirement__: You forked the repository
...
Your program must be divided into __multiple functions__.
...
1. Ask the user for the __student name__ and read it using getline
2. Ask for three scores:

   * Homework
   * Midterm
   * Final exam
3. Store all inputs using __call-by-reference parameters__
...
Return the results using __reference parameters__.
